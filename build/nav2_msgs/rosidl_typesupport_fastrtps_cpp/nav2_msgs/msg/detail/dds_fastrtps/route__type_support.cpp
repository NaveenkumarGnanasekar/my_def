...
#include "nav2_msgs/msg/detail/route__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::msg::Route & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::msg::Route & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RouteNode(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nav2_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RouteEdge(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::Route;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, Route)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
